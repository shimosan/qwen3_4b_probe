...
![Language similarity matrix M (Ward order)](images/mling_demo_heatmap_ward.png)
...
![en→L transfer performance vs raw cosine](images/mling_demo_transfer_vs_raw.png)
...
![t-SNE of the raw embeddings](images/mling_demo_raw_tsne.png)
...
![t-SNE after the inverse concept transform](images/mling_demo_x_tsne.png)
